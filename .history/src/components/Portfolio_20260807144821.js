...
export const Portfolio = () => {
  ...
  return (
    <section className="portfolio py-5 bg-light" id="portfolio">
      <div className="container">
        {/* En-tête de la section */}
        <div className="row text-center mb-5">
          <div className="col-12">
            <h2 className="dark-color fw-bold">My Projects</h2>
            <div
              className="mx-auto"
              style={{
                width: "60px",
        ...
        <div className="row justify-content-center">
          {projects.map((project) => (
            <div className="col-lg-8 col-md-10 mb-4" key={project.id}>
