  ...
  const projects = [
    {
      ...
      demoLink: "https://jarraymassaoud.github.io/react-web/", // Lien vers le site en ligne (ex: Vercel / Netlify)
      githubLink: "https://github.com/jarraymassaoud/react-web", // Lien vers ton GitHub
    },
  ];
      ...
      <div className="container">
        ...
        <div className="row justify-content-center">
          {projects.map((project) => (
            <div className="col-lg-8 col-md-10 mb-5" key={project.id}>
